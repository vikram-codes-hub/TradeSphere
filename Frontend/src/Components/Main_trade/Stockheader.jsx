      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <div style={{
            ...
            height:         "46px",
            borderRadius:   "12px",
            background:     "linear-gradient(135deg, rgba(45,126,247,0.2), rgba(45,126,247,0.05))",
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{
                ...
                padding:      "2px 7px",
                borderRadius: "5px",
                background:   stock.exchange === "NSE" ? "rgba(45,126,247,0.12)" : "rgba(167,139,250,0.12)",
                color:        stock.exchange === "NSE" ? "#2d7ef7" : "#a78bfa",
                letterSpacing:"0.06em",
              }}>
                {stock.exchange}
              </span>
              {stock.isHalted && (
                <span style={{ fontSize: "9px", fontWeight: "700", padding: "2px 7px", borderRadius: "5px", background: "rgba(255,77,109,0.12)", color: "#ff4d6d", letterSpacing: "0.06em" }}>
                  HALTED
                </span>
              )}
            </div>
            <div style={{ fontSize: "12px", color: "#64748b", marginTop: "2px" }}>{stock.name} · {stock.sector}</div>
          </div>
        </div>
      </div>
